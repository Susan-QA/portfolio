...
Willkommen in meinem persönlichen QA- und Python-Portfolio.
Hier dokumentiere ich meinen Lernfortschritt, erstelle Beispiele aus dem Software-Testing und entwickle kleine Automationsprojekte mit Python.

## 🎯 Ziele

- Einstieg als **QA Engineer / Python Automation Developer**
(Remote oder Hybrid)

- Aufbau eines strukturierten Portfolios

- Dokumentation von Projekten, Testmethoden und Lernfortschritten
...
- Testdokumentation (z. B. Testfälle, Beobachtungen, Ergebnisse)

- Web-Tests & Funktionsprüfungen

### 🤖 automation-practice

- Python-Übungen

- kleine Automation-Skripte

- erste Schritte Richtung Testautomatisierung

### 📘 notes

- Lernnotizen

- Zusammenfassungen zu QA, Python, Tools & Methoden

## 📝 Hinweise

Alle Inhalte dienen dem Lernen & zur Portfolio-Erweiterung
